...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              //<a href="list.php?country=Canada" role="button"
			  //class="btn btn-default"> Canada</a> 
		     ksort($countries);
			 foreach($countries as $value){
				$link = '<a href="list.php?country="'.$value.'" role="button" class="btn btn-default">'
				.$value.'</a>';
				echo "$link";
			}
?>
   ...
   //              </a>
			...
			$addPictures = '<li><a href="detail.php?id='
			.$value["id"].'" class="img-responsive">
			<img src="images/square/'.$value["path"].
			'" alt="'
			.$value["title"].
			'">	<div class="caption"><div class="blur"></div>
			<div class="caption-text">
			<h1>'.$value["description"].'</h1></div></div></a></li>';
			echo "$addPictures";
			}
